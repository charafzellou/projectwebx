...
<html lang="fr-FR">
	...
	<body class="container">
		...
		<div class="post">
			...
			<div class="row" id="galleryhome">
				<!-- IMAGES VONT ICI
				<img src="img/heli1.jpg" width="50%"/>-->
			</div>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img class="img-responsive center-block"src="img/heli1.jpg" style="width:50%">
					</div>
					<div class="item">
						<img class="img-responsive center-block"src="img/heli2.jpg" style="width:50%">
					</div>
					<div class="item">
						<img class="img-responsive center-block"src="img/heli3.jpg" style="width:50%">
					</div>
				</div>
